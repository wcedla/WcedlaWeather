...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=c864606856d54eedb9f63a6cc0edd91f";
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        String weatherInfo = weather.now.detialInfo.info;
        ...
        for (ForeCast forecast : weather.foreCastList) {
            ...
            infoText.setText(forecast.detialInfo.info);
        ...
        String sport = "运行建议：" + weather.suggestion.sport.sportInfo;
